...
########################################################################
# This is a main for running an MPI program on the CSG cluster.
# To use this main, call it with the following command:
# sbatch run-main-2-nodes.sh
########################################################################
...
# mpirun --display-map main sample_cli_parameter
